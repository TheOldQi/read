package com.xiafei.read.springboot.part1.s2common.spelandresource;
 ...
 */
@Configuration
@ComponentScan("com.xiafei.read.springboot.part1.s2common.spelandresource")
@PropertySource("classpath:com/xiafei/read/springboot/part1/s2common/spelandresource/test.properties")
public class SpelResourceConfig {
     ...
     * 注入文件.
     */
    @Value("classpath:com/xiafei/read/springboot/part1/s2common/spelandresource/test.txt")
